...
String serns, macs, gids, uids, ions, dcs0, dcs1, dcs2, dcs3, dcs4, dcs5, dcs6, dcs7, acs0, acs1, acs2, acs3, acs4, acs5, acs6, acs7, upds, cns = String("");
String * configItems[23];
...
String versionNumber = String("V 1.3");
...
void onLeftRelease() {
  ...
  if (warningMenu1) {
    if (leftRed.isReleased() && leftPressedTwice) {
      ...
      M5.Lcd.drawString("OUTPUT CONFIG", 50, 100, 1);
      M5.Lcd.drawString("MQTT CONFIG", 50, 150, 1);
...
void analyzeFTPFileContents(String topic) {
  ...
  if (topic.substring(topic.length() - 2, topic.length()).equalsIgnoreCase("CN")) {
    ...
    *configItems[22] = "NAME: " + consumerName;
  }
