...
//#include <M5GFX.h>
#include <SPI.h>
//#include <FS.h>   // <-- Add this for the 'File' data type
//#include <SD.h>   // <-- Add this for the 'SD' object functionality
#include <SdFat.h>  // <-- NEW SD Card Library!
#include <Ethernet.h>
...
//============ Defines & Macros ====================
#define MAX_SPEAKER_VOLUME 255
#define REGULAR_SPEAKER_VOLUME 100
// Explicit Core2 SD Card Pins
#define SD_MOSI 23
#define SD_MISO 38
#define SD_SCK  18
#define SD_CS   4
#define LCD_CS  5  // <-- The Display Chip Select Pin
#define UPDATE_BINARY_FILE_SIZE                1000000
...
extern unsigned long long checkForSubscribeCurrentMillis;
extern unsigned long long checkForSubscribePreviousMillis;
extern long long           checkForPublishInterval;                         		//-- from M5StackMQTTFTP
extern unsigned long long checkForPublishCurrentMillis;
extern unsigned long long checkForPublishPreviousMillis;
...
//extern m5::Button_Class          leftRed;                           		//-- from M5StackMQTTFTP
...
//extern m5::Button_Class          rightRed;                          		//-- from M5StackMQTTFTP
...
//extern m5::Button_Class centerRed;
...
extern const long long heartbeatPublishInterval;
...
extern int pcfw1Out1Recv;
extern int pcfw1Out2Recv;
extern int pcfw1Out3Recv;
extern int pcfw1Out4Recv;
extern int pcfw1Out5Recv;
extern int pcfw1Out6Recv;
extern int pcfw1Out7Recv;
extern int pcfw1Out8Recv;
...
//extern bool displayThreadReady;
//extern bool updateThreadReady;
