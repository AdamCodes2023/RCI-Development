...
void updateOutputsFromTags() {
  ...
  if (newDO1Available(String(pcfw1Out1Recv))) {
  ...
  if (newDO2Available(String(pcfw1Out2Recv))) {
  ...
  if (newDO3Available(String(pcfw1Out3Recv))) {
  ...
  if (newDO4Available(String(pcfw1Out4Recv))) {
  ...
  if (newDO5Available(String(pcfw1Out5Recv))) {
  ...
  if (newDO6Available(String(pcfw1Out6Recv))) {
  ...
  if (newDO7Available(String(pcfw1Out7Recv))) {
  ...
  if (newDO8Available(String(pcfw1Out8Recv))) {
