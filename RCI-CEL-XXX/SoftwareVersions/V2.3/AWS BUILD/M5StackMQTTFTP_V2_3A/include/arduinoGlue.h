...
//============ Defines & Macros ====================
#define RCI_MODEL_TYPE                      "CEL"
#define RCI_FIRMWARE_VERSION                "V 2.3A"

#define UPDATE_BINARY_FILE_SIZE                2000000
#define MESSAGING_HOST_UNIT_ID                 "01"
...
#define FTP_LOG_DIRECTORY_SUFFIX               "logs"
#define MQTT_BROKER_PROVIDER                   "AWS"
#define MQTT_SPARKPLUGB_TOPIC_PREFIX           "spBv1.0/"
#define MQTT_SPARKPLUGB_ACK_TOPIC_PREFIX       "SPARKPLUGB_ACK_"
#define MQTT_TOPIC_LAYER_SEPARATION_CHAR       "/"
#define MQTT_WILDCARD_TOPIC_SUFFIX             "/#"
#define MQTT_ANY_LAYER_TOPIC_CHARS             "/+/"
#define NORMAL_MAX_SPARKPLUGB_MESSAGE_LOOP_COUNT 2
#define EXTENDED_MAX_SPARKPLUGB_MESSAGE_LOOP_COUNT 11
#define NORMAL_MAX_SPARKPLUGB_MESSAGE_RETRIES  10
#define EXTENDED_MAX_SPARKPLUGB_MESSAGE_RETRIES 11
...
extern const uint8_t   beep[6144];
extern const uint8_t   freezeBeep[51828];
...
extern String          logFileName;                             //-- from M5StackMQTTFTP
...
extern SSLClientParameters mTLS;                                //-- from M5StackMQTTFTP
extern SSLClient       ethClientSSL;                      		//-- from M5StackMQTTFTP
extern EthernetClient  signalClient;                   		    //-- from M5StackMQTTFTP
...
extern time_t          firstTimeValue;                          //-- from M5StackMQTTFTP
...
extern int32_t             pcfr0Prev;                         		//-- from M5StackMQTTFTP
extern int             pcfr0Test;                         		//-- from M5StackMQTTFTP
extern int32_t             pcfr1Prev;                         		//-- from M5StackMQTTFTP
extern int             pcfr1Test;                         		//-- from M5StackMQTTFTP
extern int32_t             pcfr2Prev;                         		//-- from M5StackMQTTFTP
extern int             pcfr2Test;                         		//-- from M5StackMQTTFTP
extern int32_t             pcfr3Prev;                         		//-- from M5StackMQTTFTP
extern int             pcfr3Test;                         		//-- from M5StackMQTTFTP
extern int32_t             pcfr4Prev;                         		//-- from M5StackMQTTFTP
extern int             pcfr4Test;                         		//-- from M5StackMQTTFTP
extern int32_t             pcfr5Prev;                         		//-- from M5StackMQTTFTP
extern int             pcfr5Test;                         		//-- from M5StackMQTTFTP
extern int32_t             pcfr6Prev;                         		//-- from M5StackMQTTFTP
extern int             pcfr6Test;                         		//-- from M5StackMQTTFTP
extern int32_t             pcfr7Prev;                         		//-- from M5StackMQTTFTP
...
extern bool            sparkplugRetained;                       //-- from M5StackMQTTFTP
...
extern String          signalStatusString;                      //-- from M5StackMQTTFTP
...
extern const long long heartbeatCheckInterval;
...
extern String config_dump_feed;
extern String modem_sn_feed;
extern String modem_rssi_feed;
extern bool publishSoftwareVersionFlag;
extern bool publishConfigDumpFlag;
extern bool publishModemSerialNumberFlag;
extern bool publishModemRSSIFlag;
...
extern const char* publishConfigPrefKey;
extern const char* publishCredsPrefKey;
extern const char* publishInternalPrefKey;
extern const char* publishApiPrefKey;
extern bool receivedConfigFTP;
extern bool receivedCredsFTP;
extern bool receivedInternalFTP;
extern bool receivedApiFTP;
extern SparkplugNodeConfig* sparkplugNode;
extern SparkplugNodeState sparkplugNodeState;
extern size_t payload_buffer_size;
extern String sparkplugb_feed;
extern String sparkplugb_ncmd_feed;
extern String sparkplugb_ndata_feed;
extern String sparkplugb_all_feed;
extern int32_t pcfw1Out1Recv;
extern int32_t pcfw1Out2Recv;
extern int32_t pcfw1Out3Recv;
extern int32_t pcfw1Out4Recv;
extern int32_t pcfw1Out5Recv;
extern int32_t pcfw1Out6Recv;
extern int32_t pcfw1Out7Recv;
extern int32_t pcfw1Out8Recv;
extern int16_t dac1Out1Recv;
extern int16_t dac1Out2Recv;
extern int16_t dac1Out3Recv;
extern int16_t dac1Out4Recv;
extern int16_t dac2Out1Recv;
extern int16_t dac2Out2Recv;
extern int16_t dac2Out3Recv;
extern int16_t dac2Out4Recv;
extern String sparkplugb_feedACK;
extern bool receivedSparkplugBMessage;
extern bool sentSparkplugBMessage;
extern short sentSparkplugBMessageLoopCount;
extern int numberOfRemoteUnits;
extern int connectedRemoteUnitIDs[20];
extern short sentSparkplugBMessageRetries;
extern bool extendSentSparkplugBMessageRetry;
extern const long long extendedSentSparkplugBMessageRetryInterval;
extern unsigned long long extendedSentSparkplugBMessageRetryPreviousMillis;
extern unsigned long long extendedSentSparkplugBMessageRetryCurrentMillis;
extern const short continuousUpdateComponentsInterval;
extern unsigned long long continuousUpdateComponentsPreviousMillis;
extern unsigned long long continuousUpdateComponentsCurrentMillis;
extern bool isHost;
extern short signalCounter;
extern bool logDisconnect;
extern String log_upload_feed;
extern bool sentLogFTP;
extern bool logUploadStep1;
extern bool logUploadStep1PubOnce;
extern bool logUploadStep2;
extern bool logUploadStep2PubOnce;
extern bool logUploadStep3;
extern String uploadLogFileName;
extern String deleteLogFileName;
extern String log_delete_feed;
extern bool deletedLogFTP;
extern bool logDeleteStep1;
extern bool logDeleteStep1PubOnce;
extern bool logDeleteStep2;
extern bool logDeleteStep2PubOnce;
extern bool logDeleteStep3;
extern String lastLoggedSignalStrengthString;
extern const long long logCellularSignalDataInterval;
extern unsigned long long logCellularSignalDataPreviousMillis;
extern unsigned long long logCellularSignalDataCurrentMillis;
extern const char* loggingEnabledKey;
extern bool loggingEnabled;
extern bool publishLoggingStatus;
extern String ftpLogWorkingDirectory;
extern bool leftCyclingFrozenHeld;
extern bool cyclingFrozen;
extern const short cyclingFreezeInterval;
extern const char* configStringKey;
extern String configString;
extern bool sdStorageSuccess;
extern bool configReadSuccess;

extern const char* tzInfo;
extern const char* lastSavedMonthKey;
extern const char* lastSavedYearKey;
extern int lastSavedMonthTracker;
extern int lastSavedYearTracker;
struct tm timeinfo;
...
void publishConfigDump();
void publishModemSerialNumber();  
void publishModemRSSI();
void signalQualityRoutine();      
void clearUpdateFlags();   
void requestCellularSignalQualityGLIMPSE();
void manageSparkplugNodeState();
void printSparkplugNodeConfig(SparkplugNodeConfig* node);
uint64_t timestampFunction();
bool publishSparkplugBMessage(const char* topic, uint8_t* buffer, size_t buffer_length);
bool publishSparkplugBLastWill(const char* topic, uint8_t* buffer, size_t buffer_length);
void createSparkplugTags();
void NCMDcallback(int messageLength);
void updateOutputsFromTags();
void publishSparkplugBAck();
void collectRemoteUnitIDs(String remoteUnitID);
//Continuous Display Functions
...
void publishLogUpload();
void publishLogDelete();
void logConnect();
void logDelete();
void publishLogActive();
