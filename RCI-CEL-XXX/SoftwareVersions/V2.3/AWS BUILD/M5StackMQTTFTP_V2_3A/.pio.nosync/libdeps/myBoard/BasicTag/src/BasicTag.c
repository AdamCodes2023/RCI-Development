...
static bool _init_functional_basic_tag(FunctionalBasicTag* tag, const char* name, void* value_address, int alias, SparkplugDataType datatype, bool local_writable, bool remote_writable, size_t buffer_value_max_len) {
