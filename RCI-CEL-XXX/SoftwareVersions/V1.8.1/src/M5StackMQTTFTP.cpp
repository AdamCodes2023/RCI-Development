...
String versionNumber = String("V 1.8.1");
...
const long publishAllInterval = 3600000;
const long clearTextInterval = 2000;
const long reconnectInterval = 1800000;
...
const long long requestSignalQualityInterval = 30000; /*3600000*/
...
const long updateSignalDeviceInfoInterval = 30000;
const long receiveSignalQualityInterval = 15000;
...
unsigned long reconnectCurrentMillis = 0;
...
void loop() {
  ...
  if (cfgServerMode) {
    ...
    if ((viewConfigItemsIterator <= RSSI_DEVICE_INFO_INDEX && RSSI_DEVICE_INFO_INDEX <= viewConfigItemsIterator + VIEWABLE_DEVICE_INFO_INDEX_RANGE) || (viewConfigItemsIterator <= SIGNAL_QUALITY_DEVICE_INFO_INDEX && SIGNAL_QUALITY_DEVICE_INFO_INDEX <= viewConfigItemsIterator + VIEWABLE_DEVICE_INFO_INDEX_RANGE)) {
