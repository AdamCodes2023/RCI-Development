...
extern const long      commFailInterval;                  		//-- from M5StackMQTTFTP
...
extern const long      cyclingPauseInterval;              		//-- from M5StackMQTTFTP
...
extern const long      publishAllInterval;                          		//-- from M5StackMQTTFTP
extern const long      clearTextInterval;                         		//-- from M5StackMQTTFTP
extern const long      reconnectInterval;                         		//-- from M5StackMQTTFTP
extern const long      cycleComponentsInterval;                         		//-- from M5StackMQTTFTP
extern long            checkForSubscribeInterval;                         		//-- from M5StackMQTTFTP
extern long            checkForPublishInterval;                         		//-- from M5StackMQTTFTP
...
extern const long      startUpInterval;                   		//-- from M5StackMQTTFTP
...
extern const long      timeOutInterval;                   		//-- from M5StackMQTTFTP
...
extern unsigned long reconnectCurrentMillis;
...
extern const long updateSignalDeviceInfoInterval;
...
extern const long receiveSignalQualityInterval;
