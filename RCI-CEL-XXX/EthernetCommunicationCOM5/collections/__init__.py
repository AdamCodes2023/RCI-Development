import sys
from lib._collections_abc import dict_items, dict_keys, dict_values
from lib._typeshed import SupportsItems, SupportsKeysAndGetItem, SupportsRichComparison, SupportsRichComparisonT
from lib.typing import Any, Generic, NoReturn, TypeVar, overload
from lib.typing_extensions import Self, SupportsIndex, final

if sys.version_info >= (3, 9):
    from lib.types import GenericAlias

if sys.version_info >= (3, 10):
    from lib.collections.abc import (
        Callable,
        ItemsView,
        Iterable,
        Iterator,
    ...
    from lib._collections_abc import *
