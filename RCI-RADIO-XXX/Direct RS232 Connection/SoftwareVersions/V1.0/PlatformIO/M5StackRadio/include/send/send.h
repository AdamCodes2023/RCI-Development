...
void publishDataQuery(int targetUnitID) {
  ...
  //M5.Lcd.fillRect(10, 200, 300, 50, BLACK);
  //M5.Lcd.drawString("PUBLISHING ALL!", 10, 200, 1);
  replaceText(10, 200, 300, 50, 1, "QUERYING UNIT " + stringTargetUnitID + "!");
  clearTextPreviousMillis = millis();
  clear = true;
...
void publishSignalSend() {
  //M5.Lcd.fillRect(10, 200, 300, 50, BLACK);
  //M5.Lcd.drawString("PUBLISHING ALL!", 10, 200, 1);
  //replaceText(10, 200, 300, 50, 1, "SENDING SIGNAL!");
  //clearTextPreviousMillis = millis();
  //clear = true;
...
void publishSignalQuery(String targetUnitID) {
  //M5.Lcd.fillRect(10, 200, 300, 50, BLACK);
  //M5.Lcd.drawString("PUBLISHING ALL!", 10, 200, 1);
  //replaceText(10, 200, 300, 50, 1, "QUERYING SIGNAL!");
  //clearTextPreviousMillis = millis();
  //clear = true;

  sentRadioString += (groupID + "_" + targetUnitID + "!");
  radioSerialRS232.write(sentRadioString.c_str());
  sentRadioString = groupID + "_" + unitID + "#";
}