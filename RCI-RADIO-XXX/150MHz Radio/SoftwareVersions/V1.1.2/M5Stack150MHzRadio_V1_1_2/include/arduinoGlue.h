...
//============ Defines & Macros ====================
#define RCI_MODEL_TYPE                      "RF150"
#define RCI_FIRMWARE_VERSION                "V 1.1.2"
...
#define RADIO_MODEM_SET_OTA_PACKET_SIZE_VALUE "256" // Radio Modem Set OTA Packet Size AT Command Value (256 Bytes)
...
#define RADIO_MODEM_DESTINATION_ID_HOST "00" + MESSAGING_HOST_UNIT_ID // Radio Modem Destination Address HOST ONLY (0001)
#define RADIO_MODEM_UNIT_ID_MASK "FF00" // Radio Modem Listener Addresses (00-99)
#define MAXIMUM_RADIO_POWER_WATTS 2.0
...
#define RADIO_MODEM_SET_OTA_PACKET_SIZE_ATCOMMAND "ATTT" // Radio Modem Set OTA Packet Size AT Command
...
extern String          macString;                               //-- from M5StackRadio
...
extern unsigned long long startUpPreviousMillis;
...
extern unsigned long long startUpCurrentMillis;
...
extern String radioModemSelectedPHP;
extern String radioModemSelectedSHP;
extern String radioModemSelectedNetworkID;
// Bluetooth Variables
extern BLEServer *pServer;
extern BLECharacteristic *pSendConfigCharacteristic;
extern BLECharacteristic *pDisplayConfigCharacteristic;
extern BLECharacteristic *pUpdateProgressCharacteristic;
extern String initialBluetoothRciInfo;
extern String rciBluetoothDeviceName;
extern bool bluetoothActive;
extern bool simulationMode;
extern bool otaInProgress;
extern uint32_t otaReceived;
extern bool fwUpdateFlag;
extern bool fwWriteFlag;
extern const int bluetoothWaitInterval;
extern unsigned long long bluetoothPreviousMillis;
extern unsigned long long bluetoothCurrentMillis;
...
extern bool radioTestMode;
extern const int radioTestModeInterval;
extern unsigned long long radioTestModePreviousMillis;
extern unsigned long long radioTestModeCurrentMillis;
...
void reconnectMqtt();                                       
void analyzeBLEWriteContents(String topic);                  
...
void updateRSSIRoutine();
void enterContinuousRadioTest();
void exitContinuousRadioTest();
void escapeRadioTestScreen();
#endif // ARDUINOGLUE_H