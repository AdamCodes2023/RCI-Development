...
#include "Arduino.h"
#include "bluetooth/extrabluetooth.h"
...
String versionNumber = String("V 1.0.2");
...
const long long signalTestInterval = 30000;
...
void setup() {
  ...
  *configItems[23] = "RFPOW: " + radioModemSelectedRFPower + " RCHAN: " + radioModemSelectedChannel;
  ...
  *ai_feeds[0] + ";" + *ai_feeds[1] + ";" + *ai_feeds[2] + ";" + *ai_feeds[3] + ";" + *ai_feeds[4] + ";" + *ai_feeds[5] + ";" + *ai_feeds[6] + ";" + *ai_feeds[7] + ";" +
  ...
  String rciBluetoothDeviceName = rciTitle + String(" ") + serialNumber;
