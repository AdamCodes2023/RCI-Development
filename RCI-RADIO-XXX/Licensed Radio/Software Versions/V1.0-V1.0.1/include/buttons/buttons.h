    ...
    if (leftRed.isReleased() && leftPressedOnce) {
      ...
      if (configMenu1) {
        if (configMenu1Iterator < 0) {
          configMenu1Iterator = 2; //CHANGE TO ADJUST NUMBER OF MENUS (DO NOT FORGET TO ADJUST GREEN SELECTION SQUARE)
        }
      }
      else if (configMenu2) {
        if (configMenu1Iterator < 0) {
...
void onCenterRelease() {
  ...
  if (configMenu1 || configMenu2) {
    if (centerRed.isReleased() && centerPressedOnce) {
      ...
      configMenu1Iterator++;
      if (configMenu1) {
        if (configMenu1Iterator > 2) { //CHANGE TO ADJUST NUMBER OF MENUS (DO NOT FORGET TO ADJUST GREEN SELECTION SQUARE)
