...
#define MESSAGING_HOST_UNIT_ID "00" // RCI Host Unit ID for Data Message Formatting
...
#define RADIO_MODEM_DESTINATION_ID_HOST "0000" // Radio Modem Destination Address HOST ONLY (0000)
