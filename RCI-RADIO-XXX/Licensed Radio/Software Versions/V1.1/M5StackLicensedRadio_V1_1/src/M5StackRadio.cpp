...
String radioModemSelectedRFPower = String("NA");
String radioModemSelectedChannel = String("NA");
...
const long long waitForSignalQueryResponseInterval = 5000;
...
void setup() {
  ...
  *configItems[23] = "RPOW: " + radioModemSelectedRFPower + " RCHA: " + radioModemSelectedChannel;
...
void loop() {
  ...
  if (!normalMode && timeOutCurrentMillis - timeOutPreviousMillis >= timeOutInterval && !otaInProgress) {
    returnToNormalOperation();
  }
}